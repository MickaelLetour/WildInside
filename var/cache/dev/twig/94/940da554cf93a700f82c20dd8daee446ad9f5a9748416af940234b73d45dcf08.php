...
class __TwigTemplate_bf0a959bcf2685fcac4d63cf1c414232d3feb9145843055a0bae983f21a4c5a2 extends Template
{
    ...
    <h1 class=\"text-center text-uppercase m-5\">";
        ...
        ";
        // line 83
        if ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 83, $this->source); })()), "description", [], "any", false, false, false, 83), null))) {
            // line 84
        ...
        // line 87
        echo "    ";
        if ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 87, $this->source); })()), "content", [], "any", false, false, false, 87), null))) {
            // line 88
            echo "        <div class=\"mt-4\">";
